...
Plans:\
\
V3.08 - implement approved post deletion confirmation\
V3.09 - implement vacation insertion check, make rubric & frequency switch more careful and on specified date\
